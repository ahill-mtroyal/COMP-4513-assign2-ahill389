...
const PaintingThumb = (props)=>{
    ...
    return(
        <div className='ml-5 mr-5 mb-5 w-32 flex flex-wrap h-100 overflow-hidden bg-white/50 rounded-xl'>
            <img className='painting-thumb' src={`https://ahill-mtroyal.github.io/COMP-4513-assign2-ahill389/paintings/square/${painting.imageFileName}.jpg`} alt={painting.title} onClick={paintingModal} style={{height:'128px', width:'128px'}}/><br/>

...
const ArtistsInfoCard = (props)=>{
    ...
    return(
        <div className='flex flex-col h-full text-xl space-y-10  pt-5 '>
            ...
            <img className="rounded-lg" src={`https://ahill-mtroyal.github.io/COMP-4513-assign2-ahill389/artists/square/${selectedArtist.artistId}.jpg`} alt={`${selectedArtist.firstName} ${selectedArtist.lastName}`}/>
